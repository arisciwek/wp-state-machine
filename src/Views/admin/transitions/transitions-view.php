 ...
 * @author      arisciwek
 *
 * Path: /wp-state-machine/src/Views/admin/transitions/transitions-view.php
 *
 ...
 *              All CSS and JS extracted to separate files.
 *
 * Changelog:
 * 1.0.1 - 2025-11-08
 * - Renamed from index.php to transitions-view.php
 * - Extracted all inline CSS to transitions.css
 * - Extracted all inline JS to transitions.js
 * - Clean HTML-only view following established pattern
 *
 * 1.0.0 - 2025-11-07
 * - Initial creation
...
<!-- Assets (transitions.css and transitions.js) are loaded via class-dependencies.php -->
<!-- JavaScript data is localized via wpStateMachineTransitionsData -->
